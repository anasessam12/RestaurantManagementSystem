...
public class Employeeframe extends javax.swing.JFrame {
    ...
    private void deleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteMouseClicked
        ...
        cust_manage.setSelectedIndex(2);
        customerController.ListCustomers(cust_table);
    ...
    private void butupdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_butupdateMouseClicked
        ...
        customerModel.setId(customerID);
        customerController.SendCustomer(customerModel, c_name, e_id1);
    ...
    private void searchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_searchMouseClicked
        ...
        customerModel.setId(customerID);
        customerController.SearchForCustomer(search_table, customerModel);
