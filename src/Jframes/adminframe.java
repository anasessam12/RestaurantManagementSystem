...
public class adminframe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        empRadio.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                empRadioMouseClicked(evt);
            }
        });
    ...
    private void delete_mealMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_delete_mealMouseClicked
        ...
        mealController.delete(mealModel);
        try {
            mealController.list(search_table1);
    ...
    private void butupdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_butupdateMouseClicked
        ...
        selectedRow = search_table1.getSelectedRow();
        ID = Integer.parseInt((String) search_table1.getValueAt(selectedRow, 0));
        mealModel.setMealId(ID);
        try {
            mealController.send(mealModel, m_name, m_price, m_quan);
        } catch (SQLException ex) {
            Logger.getLogger(adminframe.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void searchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_searchMouseClicked
        ...
        mealModel.setMealId(ID);
        try {
            mealController.search(search_table1, mealModel);
        } catch (SQLException ex) {
            Logger.getLogger(adminframe.class.getName()).log(Level.SEVERE, null, ex);
        }
        clear_searchMeal();
    ...
    private void add_offerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_add_offerMouseClicked
        ...
        adminController.setOffer(offerModel, adminModel);
        clear_offer();
    ...
    private void reportButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_reportButtonMouseClicked
        ...
        adminController.report(roleID, reportTable, userModel, reportDescription);
        id2.setText("");
        description.setText("");
        clear_report();
    ...
    private void cust_addMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cust_addMouseClicked
        ...
        adminModel.setId(adminId);
        mealController.add(mealModel, adminModel);
        meals.setSelectedIndex(2);
        try {
            mealController.list(meal_table2);
        } catch (SQLException ex) {
            Logger.getLogger(adminframe.class.getName()).log(Level.SEVERE, null, ex);
        }
        clear_addMeal();
    ...
    private void jLabel35MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel35MouseClicked
        ...
        mealController.update(mealModel);
        meals.setSelectedIndex(2);
        try {
            mealController.list(meal_table2);
        } catch (SQLException ex) {
    ...
    private void empRadioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_empRadioMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_empRadioMouseClicked
